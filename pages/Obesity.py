...
def main():
    ...
    if scc == "Yes":
        ...
        SCC = 0
    FAF = st.text_input("Как часто занимаетесь физическими активностями", "")
    TUE = st.text_input("Сколько часов тратите на электронные устройства (сматрфон, комп., телевизор, видео-игры итд)","")
